...
// Video widget for bear WordPress theme

class bear_video_widget extends WP_Widget {

	function __construct() {
        $widget_ops = array( 'classname' => 'bear_video_widget', 'description' => __('Displays a video of your choosing.', 'bear') );
        parent::__construct( 'bear_video_widget', __('Video Widget','bear'), $widget_ops );
    }
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('video_widget_url'); ?>"><?php  _e('Video URL', 'bear'); ?>:
...
register_widget('bear_video_widget'); ?>