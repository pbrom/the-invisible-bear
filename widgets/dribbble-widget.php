...
// Dribbble widget for bear WordPress theme

include_once(ABSPATH . WPINC . '/feed.php');

class bear_dribbble_widget extends WP_Widget {

	function __construct() {
        $widget_ops = array( 'classname' => 'bear_dribbble_widget', 'description' => __('Displays your latest Dribbble photos.', 'bear') );
        parent::__construct( 'bear_dribbble_widget', __('Dribbble Widget','bear'), $widget_ops );
    }
		...
		if (!empty($widget_title)) {
			...
			if (!empty($items)): ?>
				...
				<div class="dribbble-container">
					...
					<p class="widgetmore"><a href="http://www.dribbble.com/<?php echo $dribbble_user; ?>"><?php printf( __('Follow %s on Dribbble','bear') . ' &raquo;', $dribbble_username); ?></a></p>
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('widget_title'); ?>"><?php  _e('Title', 'bear'); ?>:
		...
		<p>
			<label for="<?php echo $this->get_field_id('dribbble_username'); ?>"><?php  _e('Dribbble username', 'bear'); ?>:
		...
		<p>
			<label for="<?php echo $this->get_field_id('dribbble_number'); ?>"><?php _e('Number of images to display:', 'bear'); ?>
...
register_widget('bear_dribbble_widget'); ?>